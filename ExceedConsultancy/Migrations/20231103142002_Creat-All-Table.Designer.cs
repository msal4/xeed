...
namespace ExceedConsultancy.Migrations
{
    ...
    [Migration("20231103142002_Creat-All-Table")]
    partial class CreatAllTable
    {
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f29e13cb-8b7e-4fbb-aed4-4146e766cb40"),
                            ConcurrencyStamp = "4699cc3e-3efa-4267-bad7-d13b4a754c00",
                            Name = "Admin",
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            RoleId = new Guid("f29e13cb-8b7e-4fbb-aed4-4146e766cb40"),
                            ClaimType = "CanEdit",
                            ClaimValue = "CanEdit"
                        });
                });
