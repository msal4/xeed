...
namespace ExceedConsultancy.Migrations
{
    ...
    [Migration("20231102104842_Update-WhyUsAccordion")]
    partial class UpdateWhyUsAccordion
    {
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b1989f2d-616d-4b46-91d6-598031da4b3d"),
                            ConcurrencyStamp = "f43b0949-7fa8-456e-b13f-37ce276d3292",
                            Name = "Admin",
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            RoleId = new Guid("b1989f2d-616d-4b46-91d6-598031da4b3d"),
                            ClaimType = "CanEdit",
                            ClaimValue = "CanEdit"
                        });
                });
