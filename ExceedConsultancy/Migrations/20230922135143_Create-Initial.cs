    ...
    public partial class CreateInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AccordionId = table.Column<int>(type: "int", nullable: false),
                    ...
                    SubTitleAccordion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubTitleAccordion_Ar = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WhyUsAccordion", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetRoleClaims", x => new { x.Id, x.RoleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserClaims", x => new { x.Id, x.UserId });
                    table.ForeignKey(
