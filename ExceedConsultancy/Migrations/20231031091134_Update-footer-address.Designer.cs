...
namespace ExceedConsultancy.Migrations
{
    ...
    [Migration("20231031091134_Update-footer-address")]
    partial class Updatefooteraddress
    {
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd826f23-f6c6-48be-a728-71fb5db71781"),
                            ConcurrencyStamp = "6699316a-3d64-4d41-b330-a2d0a29de1f0",
                            Name = "Admin",
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            RoleId = new Guid("cd826f23-f6c6-48be-a728-71fb5db71781"),
                            ClaimType = "CanEdit",
                            ClaimValue = "CanEdit"
                        });
                });
