...
namespace ExceedConsultancy.Migrations
{
    ...
    [Migration("20231030085636_Creat-Address-Footer")]
    partial class CreatAddressFooter
    {
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9775a702-e64d-49f5-9efc-c58e9677cd70"),
                            ConcurrencyStamp = "3eb80025-7e8d-4c0d-a525-beeaa5da3a25",
                            Name = "Admin",
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            RoleId = new Guid("9775a702-e64d-49f5-9efc-c58e9677cd70"),
                            ClaimType = "CanEdit",
                            ClaimValue = "CanEdit"
                        });
                });
