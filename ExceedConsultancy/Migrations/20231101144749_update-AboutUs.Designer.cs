...
namespace ExceedConsultancy.Migrations
{
    ...
    [Migration("20231101144749_update-AboutUs")]
    partial class updateAboutUs
    {
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6d458a2d-4734-42c3-acb4-1b3380d3d75b"),
                            ConcurrencyStamp = "30e6b09f-3455-483f-9c68-821596f86d2b",
                            Name = "Admin",
            ...
            modelBuilder.Entity("ExceedConsultancy.Models.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            RoleId = new Guid("6d458a2d-4734-42c3-acb4-1b3380d3d75b"),
                            ClaimType = "CanEdit",
                            ClaimValue = "CanEdit"
                        });
                });
